...
treatment_results_1_vs_4 <- results(DESeq_data_1_4, contrast=c("treatment", "1", "4"), pAdjustMethod="BH" , alpha= 0.05)
...
treatment_results_2_vs_4 <- results(DESeq_data_2_4, contrast=c("treatment", "2", "4"), pAdjustMethod="BH" , alpha= 0.05)
summary(treatment_results_2_vs_4)
treatment_results_2_vs_4_sorted <- treatment_results_3_vs_4[order(treatment_results_2_vs_4$padj),]

write.csv(treatment_results_2_vs_4_sorted, file="treatment_diff_2_vs_4")
write.csv(treatment_results_2_vs_4, file="treatment_diff_name_2_vs_4")
plotDispEsts(DESeq_data_2_4, xlab="Mean of Normalized Counts", ylab="Dispersion", main="Mean Dispersion")
plotMA(DESeq_data_2_4, ylim=c(-5,5), main="LPS LPS vs vec vec")


#vec_LPS vs vec_vec mice
DESeq_data_3_4 <- DESeqDataSetFromMatrix(tot_count_matrix, experimental_design, design = formula(~treatment + age))
DESeq_data_3_4 <- DESeq(DESeq_data_3_4)
treatment_results_3_vs_4 <- results(DESeq_data_3_4, contrast=c("treatment", "3", "4"), pAdjustMethod="BH" , alpha= 0.05)
...
write.csv(treatment_results_3_vs_4, file="treatment_diff_name_3_vs_4")
